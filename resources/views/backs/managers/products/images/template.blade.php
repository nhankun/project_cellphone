    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="alert alert-info alert-dismissible">
                ...
                <h4><i class="icon fa fa-info"></i> @lang('public.alert')!</h4>
                @lang('foods.images.alert_content')
            </div>
        </div>
        <div class="col-sm-12">
            <div class="container--border-dashed" onclick="selectFile()">
                        ...
                        @if(isset($images) && $images->images != '')
                            @foreach(explode(',',$images->images) as $image)
                                <div class='col-sm-3' id='{{$i}}'>
                                    <img src="{{$image}}" style='height:150px;width:100%;border:1px solid grey' onclick="showModal(event, '{{$image}}')">
                ...
                <div class="center-parent ">
                    <i class="fa fa-fw fa-plus-square-o fa-2x center-me"></i>
                </div>
            </div>
