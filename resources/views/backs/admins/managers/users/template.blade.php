    ...
    <div class="row">
        <div class="col-8">
            <div class="form-group">
                ...
                <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="name" value="{!! isset($user) ? $user->name : old('name') !!}" placeholder="Enter name">
                @error('name')
            ...
            <div class="form-group">
                ...
                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{!! isset($user) ? $user->email : old('email') !!}" placeholder="Enter email">
                @error('email')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                ...
                <label for="avatar">
                    @if(isset($user) && $user->avatar != '')
                        <img class="profile-user-img img-fluid img-circle" src="{{asset($user->avatar)}}"
                             style="width: 158px;height: 158px;" alt="{{asset($user->name)}}">
                    @else
    ...
    <div class="row">
        <div class="col-3">
            <div class="form-group row">
                ...
                <div class="col-12">
                    <input name="phone" type="text" class="form-control @error('phone') is-invalid @enderror" id="phone"value="{!! isset($user) ? $user->phone : old('phone') !!}" placeholder="Số điện thoại">
                    @error('phone')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-2 pl-0">
                        <p class="btn btn-outline-primary" onclick="showPassword(this);"><i class="fas fa-eye"></i></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-4">
            <div class="form-group">
                ...
                <input name="address" type="text" class="form-control @error('address') is-invalid @enderror" id="address"value="{!! isset($user) ? $user->address : old('address') !!}" placeholder="Enter address">
                @error('address')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                ...
                <select name="city" class="form-control select2bs4" id="city" style="width: 100%;" onchange="changeprovince();">
                    @foreach($provinces as $province)
                        <option value="{{ $province->key }}"
                                @if(old('city', isset($user) ? $user->city : '') == $province->key)
                                    selected="selected"
                                @endif
