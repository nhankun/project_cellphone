...
{{--        </li>--}}
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                <i class="flag-icon flag-icon-@lang("public.language.icon.".App::getLocale())"></i>
            </a>
            <div class="dropdown-menu dropdown-menu-right p-0">
                @foreach (Config::get('app.languages') as $language)
                    <a href="{{ route('langroute', $language) }}" class="dropdown-item @if ($language == App::getLocale()) active @endif">
                        <i class="flag-icon flag-icon-@lang("public.language.icon.".$language) mr-2"></i> @lang("public.language.name.".$language)
                    </a>
                @endforeach
